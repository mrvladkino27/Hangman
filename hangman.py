...
def hangman(secret_word):
    ...
    * After each guess, you should display to the user the 
    ...
    while not is_word_guessed(secret_word, letters_guessed) and guesses>0:
        ...
        print('Avaliable latters:', get_available_letters(letters_tried))
        ...
        elif inp in secret_word and inp not in letters_guessed:
            letters_guessed.append(inp)
            letters_tried.append(inp)
            print("Good guess:", get_guessed_word(secret_word, letters_guessed))
      
        elif inp not in secret_word and inp not in letters_guessed:
            letters_tried.append(inp)
            if inp in vow:
                guesses-=2
